...
void setup_scr_bluetooth(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->bluetooth_bt_label_title, &lv_font_OPPOSans_Medium_36, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->bluetooth_bt_list_devices, 71, 86);
    lv_obj_set_size(ui->bluetooth_bt_list_devices, 324, 270);
    ...
    lv_style_set_text_font(&style_bluetooth_bt_list_devices_extra_btns_main_default, &lv_font_OPPOSans_Medium_16);
    ...
    lv_obj_set_pos(ui->bluetooth_bt_btn_scan, 241, 372);
    ...
    lv_obj_set_style_text_font(ui->bluetooth_bt_btn_scan, &lv_font_OPPOSans_Medium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->bluetooth_btn_back, 118, 372);
    ...
    lv_obj_set_style_text_font(ui->bluetooth_btn_back, &lv_font_OPPOSans_Medium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
