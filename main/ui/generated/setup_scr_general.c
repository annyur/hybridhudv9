...
void setup_scr_general(lv_ui *ui)
{
    ...
    lv_arc_set_bg_angles(ui->general_arc_energy, 320, 357);
    ...
    lv_obj_set_style_border_width(ui->general_cont_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->general_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->general_cont_1, lv_color_hex(0x111111), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->general_slider_energy, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->general_slider_energy, lv_color_hex(0x111111), LV_PART_MAIN|LV_STATE_DEFAULT);
